...
internal sealed class AttributeExtensions : IIncrementalGenerator
{
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        context.RegisterPostInitializationOutput(ctx => ctx.AddSource("AttributeExtensions.g.cs", Source));
    }
...
internal static class AttributeExtensions
{
    ...
    {
        internal global::EnumSerializer.Utils.AttributeExtensions.ArgumentSyntaxList? ArgumentSyntaxList
        {
            get
            {
                if (attribute.ApplicationSyntaxReference?.GetSyntax() is not global::Microsoft.CodeAnalysis.CSharp.Syntax.AttributeSyntax attributeSyntax) return null;
                if (attributeSyntax.ArgumentList is not global::Microsoft.CodeAnalysis.CSharp.Syntax.AttributeArgumentListSyntax argumentList) return null;
        ...
        internal bool TryGetNamedArgumentEnumValue<TEnum>(string argumentName, out TEnum value) where TEnum : struct, Enum
        {
            foreach (var namedArg in attribute.NamedArguments)
            {
                ...
                if (!global::EnumSerializer.Utils.AttributeExtensions.EnumCache<TEnum>.ValidValues.Contains(intValue)) break; // Check if the integer value corresponds to a defined enum member.
    ...
    {
        public static readonly global::System.Collections.Generic.HashSet<int> ValidValues = [.. global::System.Linq.Enumerable.Cast<int>(global::System.Enum.GetValues(typeof(T)))];
    } // private static class EnumCache<T> where T : struct, Enum

    internal class ArgumentSyntaxList(global::Microsoft.CodeAnalysis.CSharp.Syntax.AttributeArgumentListSyntax argumentList)
    {
        private readonly global::Microsoft.CodeAnalysis.SeparatedSyntaxList<global::Microsoft.CodeAnalysis.CSharp.Syntax.AttributeArgumentSyntax> _argumentList = argumentList.Arguments;
        ...
        internal global::Microsoft.CodeAnalysis.CSharp.Syntax.AttributeArgumentSyntax? this[string name]
        {
            get
            {
